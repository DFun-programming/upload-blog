...
import { createComment, deleteComment, getComment, likeComment } from '../../../services/operations/commentOperation';

export default function CommentSection({ postId,setPost}) {
